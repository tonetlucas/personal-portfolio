    ...
    return(
        <div className = "contact section-p">
            ...
            <div className="section-title">
                ...
                <p className="text">I offer the right solutions for you digital business</p>
                 </div>
                 </div>

                <form className="contact-form mx-auto" onSubmit={handleSubmit}>
                    <div className="form-elem">
                        <input type="text" value={formData.nome} className="form-control" placeholder="Nome" onChange={handleChange} id="nome"/>
                    </div>
                    ...
                    <div className="form-elem">
                        <textarea rows="2" value={formData.message} className="Form-control" placeholder="Message" onChange={handleChange} id="messagege"></textarea>
                    </div>
